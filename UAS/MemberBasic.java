...
public class MemberBasic {
	...
	// Method 1
	// To add books
	public void addStudent(Member s)
	{
	...
	public void checkOutBook(Books book)
	{
		...
		if (studentIndex != -1) {
			...
			if (b != null) {
				...
				if (members[studentIndex].booksCount
					<= 3) {

					System.out.println("adding book");
					members[studentIndex].borrowedBooks
						[members[studentIndex]
							.booksCount]
						= b;
					members[studentIndex].booksCount++;
